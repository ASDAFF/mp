<?
$MESS ['PRMEDIA_TC_INSTALL_NAME'] = "Древовидные комментарии";
$MESS ['PRMDEIA_TC_INSTALL_DESCRIPTION'] = "Модуль позволяет организовать на сайте комментирование статей, новостей, товаров и любой информации, представляемой с помощью элементов инфоблоков.";
