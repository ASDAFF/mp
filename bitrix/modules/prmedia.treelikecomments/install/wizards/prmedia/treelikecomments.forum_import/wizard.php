...
class CancelStep extends CWizardStep
{
	function InitStep()
	{
		$this->SetTitle(GetMessage('PRMEDIA_TLC_IMPORT_CANCEL_TITLE'));
	...
	function ShowStep()
	{
		$this->content = GetMessage('PRMEDIA_TLC_IMPORT_CANCEL_CONTENT');
	}
...
class GreetingStep extends CWizardStep
{
	function InitStep()
	{
		$this->SetTitle(GetMessage('PRMEDIA_TLC_IMPORT_GREETING_TITLE'));
	...
	function ShowStep()
	{
		$this->content = GetMessage('PRMEDIA_TLC_IMPORT_GREETING_CONTENT');
	}
}
...
class ImportStep extends CWizardStep
{
	...
	function InitStep()
	{
		$this->SetTitle(GetMessage('PRMEDIA_TLC_IMPORT_IMPORT_TITLE'));
...
class FinalStep extends CWizardStep
{
	function InitStep()
	{
		$this->SetTitle(GetMessage('PRMEDIA_TLC_IMPORT_FINAL_TITLE'));
		$this->SetStepID('final_step');
		$this->SetCancelStep('final_step');
		$this->SetCancelCaption(GetMessage('PRMEDIA_TLC_IMPORT_FINAL_CANCEL_TITLE'));
	}
